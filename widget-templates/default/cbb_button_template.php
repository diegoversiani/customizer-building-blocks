...
?>
    ...
    <?php if ( ! empty( $instance['button_text'] ) ) : ?>
      <a href="<?php echo esc_url( $instance['button_href'] ); ?>" class="<?php echo esc_attr( $button_css_class ); ?>"><?php if ( ! empty( $icon_class ) ) echo '<i class="' . $icon_class . '"></i>'; ?><?php esc_html_e( $instance['button_text'] ); ?></a>
    <?php endif; ?>
