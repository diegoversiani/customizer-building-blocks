...
<li class="cbb-social-networks__list-item"><a href="<?php echo esc_url( $instance[ $social_network_url ] ); ?>" target="_blank"><i class="<?php esc_attr_e( $social_network_classes ) ?>"></i><?php echo esc_html( $instance[ $social_network_text ] ); ?></a></li>
